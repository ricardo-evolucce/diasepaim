                        ...
                        <div class="footer-nav footer-nav-links footer-nav-bottom-line">
                            <nav>
                                <ul class="nav" id="footerNav">
                                    <li>
                                        <a href="index.php" class="text-color-dark active">Início</a>
                                    </li>
                                    <li>
                                        <a href="quem-somos.php" class="text-color-dark">Quem somos</a>
                                    </li>
                                   
                                    <li>
                                        <a href="https://blog.diasepaimadvogados.com.br" class="text-color-dark">Blog</a>
                                    </li>
                                    <li>
                                        <a href="contato.php" class="text-color-dark">Contato</a>
                                    </li>
                    ...
                    <div class="row py-4">
                        <div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                            <a href="#" class="logo pe-0 pe-lg-3">
                                <img  src="img/logo-novo-2.png" height="32">
                            </a>
                        </div>
                        <div class="col-lg-11 d-flex align-items-center justify-content-center justify-content-lg-end mb-4 mb-lg-0">
                            <p>Desenvolvido por <a href="http://www.prmuller.com">PRMüller Soluções em Informática</a></p>
                        </div>
                    </div>
                </div>
            </div>
